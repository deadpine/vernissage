export function HistorySection() {
  return (
    <div className="bg-[#171614] text-white border-b-4 border-gold">
      ...
      min-h-[400px] py-[150px] md:py-[134px] relative">
        
        {/* papel */}
        <div className="max-w-[calc(100%-2rem)] md:max-w-[476px] space-y-6 mx-auto text-center px-6 py-8 md:p-9 border border-[#725337]/60 rotate-[-1deg] md:rotate-[-2deg] relative">
          <h2 className="text-4xl font-heading text-[#725337] mb-8">HISTORIA</h2>
          <p className="text-[#4B3420] font-serif text-lg">
