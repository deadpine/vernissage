export function HistorySection() {
  return (
    <div className="bg-[#171614] text-white border-b-4 border-gold">
      <div className="bg-[url('/images/history-bg.png')] bg-cover md:bg-contain bg-center bg-no-repeat min-h-[400px] py-[138px] md:py-[135px]">
        
        <div className="max-w-[calc(100%-2rem)] md:max-w-[476px] space-y-6 mx-auto text-center px-7 py-8 md:p-9 border border-[#725337] rotate-[-1deg] md:rotate-[-2deg]">
          <h2 className="text-4xl font-heading text-[#392818] mb-8">HISTORIA</h2>
